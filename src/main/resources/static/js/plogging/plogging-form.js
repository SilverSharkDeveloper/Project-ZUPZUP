...
$(".add-image").on("click",e=>{
    $("#representingImage").trigger("click");
})

$(".add-image-btn").on("click",e=>{
    $("#representingImage").trigger("click");
})

$(".delete-image-btn").on("click",e=>{
    $("#representingImage").value ="";
    $(".cover-image").css("display","none");
    $(".cover-image-add").css("display","block");
})

$("#representingImage").on("change", e => {
    ...
    reader.onload = e => {
        ...
        $(".cover-image").css("backgroundImage",`url('${e.target.result}`)
        $(".cover-image").css("background-size","100%");
        $(".cover-image").css("background-repeat","no-repeat");
        $(".cover-image").css("background-position","center");
        $(".cover-image").css("display","block");
        $(".cover-image-add").css("display","none");

        $(".add-image-btn").css("display","block");
